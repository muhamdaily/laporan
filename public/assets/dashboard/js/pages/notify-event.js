...
(function () {
  ...
  // Default style
  document.querySelector('#pnotify-default').addEventListener("click", function () {
    new PNotify.alert({
  ...
  // primary style
  document.querySelector('#pnotify-primary').addEventListener("click", function () {
    new PNotify.alert({
  ...
  document.querySelector('#pnotify-success').addEventListener("click", function () {
    new PNotify.alert({
  ...
  // Info notification
  document.querySelector('#pnotify-info').addEventListener("click", function () {
    new PNotify.alert({
      title: 'Info notice',
      text: 'Check me out! I\'m a notice.',
      type: 'info'
  ...
  // Danger notification
  document.querySelector('#pnotify-danger').addEventListener("click", function () {
    new PNotify.alert({
      title: 'Danger notice',
      text: 'Check me out! I\'m a notice.',
      type: 'error'
  ...
  // Danger
  document.querySelector('#pnotify-desktop-notice').addEventListener("click", function () {
    PNotify.notice({
  ...
  // Danger
  document.querySelector('#pnotify-desktop-danger').addEventListener("click", function () {
    PNotify.error({
  ...
  // Success
  document.querySelector('#pnotify-desktop-success').addEventListener("click", function () {
    PNotify.success({
  ...
  // Info
  document.querySelector('#pnotify-desktop-info').addEventListener("click", function () {
    PNotify.info({
      title: 'Desktop Info',
  ...
  // No title
  document.querySelector('#pnotify-no-title').addEventListener("click", function () {
    new PNotify.alert({
  ...
  // Rich content
  document.querySelector('#pnotify-rich').addEventListener("click", function () {
    PNotify.notice({
  ...
  // Close on click
  document.querySelector('#pnotify-click').addEventListener("click", function () {
  ...
  // Sticky notice
  document.querySelector('#pnotify-sticky').addEventListener("click", function () {
    PNotify.notice({
      title: 'Sticky Notice',
  ...
  // Permanent buttons
  document.querySelector('#pnotify-permanent-buttons').addEventListener("click", function () {
    PNotify.notice({
  ...
  // Confirm
  document.querySelector('#pnotify-confirm').addEventListener("click", function () {
    var notice = PNotify.notice({
  ...
  // Prompt
  document.querySelector('#pnotify-prompt').addEventListener("click", function () {
    var notice = PNotify.notice({
      title: 'Input Needed',
  ...
  // Multiline prompt
  document.querySelector('#pnotify-multiline').addEventListener("click", function () {
    var notice = PNotify.notice({
      title: 'Input Needed',
  ...
  // Custom buttons
  document.querySelector('#pnotify-buttons').addEventListener("click", function () {
    PNotify.notice({
      title: 'Choose a Side',
  ...
  // Callbacks
  document.querySelector('#pnotify-callbacks').addEventListener("click", function () {
  ...
  function fakeLoad() {
    ...
    var loader = PNotify.notice({
      ...
      modules: {
        ...
        Callbacks: {
          beforeOpen: function (notice) {
            progress = document.querySelector(notice.refs.elem).find('div.progress-bar');
  ...
  document.querySelector('#pnotify-progress').addEventListener("click", function () {
    fakeLoad();
  });


  // Dynamic loader
  document.querySelector('#pnotify-dynamic').addEventListener("click", function () {
    var percent = 0;
  ...
  // Top left
  document.querySelector('#pnotify-stack-top-left').addEventListener("click", function () {
    show_stack_top_left('primary');
  });

  // Bottom left
  document.querySelector('#pnotify-stack-bottom-left').addEventListener("click", function () {
    show_stack_bottom_left('primary');
  });

  // Bottom right
  document.querySelector('#pnotify-stack-bottom-right').addEventListener("click", function () {
    show_stack_bottom_right('danger');
  });

  // Custom left
  document.querySelector('#pnotify-stack-custom-left').addEventListener("click", function () {
    show_stack_custom_left('success');
  });

  // Custom right
  document.querySelector('#pnotify-stack-custom-right').addEventListener("click", function () {
    show_stack_custom_right('success');
  });

  // Custom top
  document.querySelector('#pnotify-stack-custom-top').addEventListener("click", function () {
    show_stack_custom_top('info');
  });

  // Custom bottom
  document.querySelector('#pnotify-stack-custom-bottom').addEventListener("click", function () {
